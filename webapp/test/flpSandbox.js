					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mass user administration",
									"targetURL": "#massuseradm-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"massuseradm-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=massuseradm",
									"url": sap.ui.require.toUrl("massuseradm")
								}
							}
						}
					}
